 ...
 */
public class LeftCamera extends Node implements AutoCloseable {
  private Camera camera;
  private Handler callbackHandler;
  private CameraManager cameraManager;

  @NamedHardware("Webcam 1")
   ...
   */
  public LeftCamera(HardwareOrchestrator orchestrator) throws RuntimeException {
    super(orchestrator);
