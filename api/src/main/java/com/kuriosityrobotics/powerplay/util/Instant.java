...
public final class Instant implements Serializable, Comparable<Instant> {
	...
	public static Instant fromSecondsSinceStart(double seconds) {
    ...
    public Instant plusSeconds(double seconds) {
        return new Instant(nanos + (long)(seconds * NANOS_PER_SECOND));
    }

    public Instant plusMillis(int millis) {
        return new Instant(nanos + (millis * NANOS_PER_MILLI));
    }


    public Instant plusNanos(int nanos) {
        return new Instant(this.nanos + nanos);
    }

    public boolean equals(Instant i) {
