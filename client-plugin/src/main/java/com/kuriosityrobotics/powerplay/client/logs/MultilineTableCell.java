...
public class MultilineTableCell
    ...
    class CellArea extends DefaultTableCellRenderer {
        ...
        public CellArea(Component c, String s, JTable tab, int row, int column,boolean isSelected) {
            component = c;
            text = s;
            rowIndex = row;
            columnIndex = column;
        ...
        public void paintComponent(Graphics gr) {
            ...
            if ( text != null && !text.isEmpty() ) {
                ...
                table.setRowHeight(rowIndex,(int) drawPosY + 2);
            }
        }
    }
    ...
    {
        CellArea area = new CellArea(table, value.toString(),table,row,column,isSelected);
        return area;
    }
}
